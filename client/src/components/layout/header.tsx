  ...
  return (
    <header className="bg-white border-b border-gray-200 z-10 sticky top-0">
      <div className="flex items-center justify-between h-16 px-6">
        <div className="flex items-center">
          ...
          <div className="relative w-64 ml-4">
            ...
            <Input
              ...
              className="pl-10 pr-3 py-2 rounded-md text-sm"
              value={searchQuery}
        ...
        <div className="flex items-center">
          <Button variant="ghost" size="icon" className="relative text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 mr-3">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
